...
let _base = process.env.NODE_ENV == 'development' ? 'activity/project/love_act/view' : 'activity/project/love_act/view';
console.log(_base)
const router = new Router({
    ...
    routes: [
        ...
        // 男士
        {
            path: `/man*(.*)+`,
            name: 'man',
            component: resolve => require(['../pages/man/app.vue'], resolve),
            meta: {
                // requireAuth: true, // 判断是否需要登录
                title: '成为更有型的ta',
            }
