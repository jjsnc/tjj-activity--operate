<template>
  <nav class="container">
    <div class="lb">
      <img src="../../assets/images/shoesBag/shoesBag_01.jpg">
      <div class="share" @click="share" v-if="xcx==false"></div>
    </div>

    <img src="../../assets/images/shoesBag/shoesBag_03.jpg">
    ...
    <div class="lists">
      ...
      >
        ...
        <div v-if="goods_lists[index].length/2>0&&index==4" class="moregoods more">
          <img src="../../assets/images/shoesBag/more_03.jpg" @click="toMore()" alt>
        </div>
      </div>
    </div>

    <img src="../../assets/images/shoesBag/shoesBag_05.jpg" class="bottom-img" @click="back()" alt>
    <ToTop></ToTop>
  </nav>
</template>
<script>
...
export default {
  data() {
    return {
      goods: [],
      shops: [
        { url: require("../../assets/images/shoesBag/1.jpg"), id: "78901" },
        { url: require("../../assets/images/shoesBag/2.jpg"), id: "25630" },
        { url: require("../../assets/images/shoesBag/3.jpg"), id: "71654" },
        { url: require("../../assets/images/shoesBag/4.jpg"), id: "87850" },
        { url: require("../../assets/images/shoesBag/5.jpg"), id: "5004" },
        { url: require("../../assets/images/shoesBag/6.jpg"), id: "14733" },
        { url: require("../../assets/images/shoesBag/7.jpg"), id: "9518" },
        { url: require("../../assets/images/shoesBag/8.jpg"), id: "5942" },
        { url: require("../../assets/images/shoesBag/9.jpg"), id: "14226" },
        { url: require("../../assets/images/shoesBag/10.jpg"), id: "12680" },
        { url: require("../../assets/images/shoesBag/11.jpg"), id: "15222" },
        { url: require("../../assets/images/shoesBag/12.png"), id: "5388" }
      ],
      navs: [
        { name: "热销榜单" },
        { name: "时尚女鞋" },
...
.share {
  ...
  right: 0.2rem;
  top: 0.27rem;
  background: url(../../assets/images/shoesBag/share_new.png);
  background-size: 100%;
