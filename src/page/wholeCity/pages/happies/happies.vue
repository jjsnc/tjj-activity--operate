...
.share {
  ...
  right: 0.2rem;
  top: 0.27rem;
  background: url(../../assets/images/happies/share_new.png);
  background-size: 100%;
...
.gl {
  ...
  right: 0.2rem;
  top: 0.9rem;
  background: url(../../assets/images/happies/more.png);
  background-size: 100%;
  background-repeat: no-repeat;
}
</style>
...
<template>
  <nav class="container">
    <div class="bg" v-if="conpon==true" @click="conpon=false">
      <img src="../../assets/images/happies/coupon.png">
    </div>
    <img src="../../assets/images/happies/index_01.jpg">
    <div class="lb">
      ...
      <img src="../../assets/images/happies/index_02.jpg">
      <div class="gl" @click="togl()"></div>
      <div class="share" @click="share" v-if="xcx==false"></div>
    </div>
    <img src="../../assets/images/happies/index_03.jpg">

    <vanSwipe :autoplay="3000" vertical :show-indicators="timer" class="ms" :touchable="false">
      <vanSwipeItem v-for="(image, index) in images" :key="index">
        <img v-lazy="image" @click="toms()">
      </vanSwipeItem>
    </vanSwipe>
    <img src="../../assets/images/happies/index_05.jpg">
            ...
            >
              ...
              <p class="goods_price_info">
                <span class="goods_price">
                  <span><font>￥</font>{{goods.group_price}}</span>
    ...
    <img src="../../assets/images/happies/index_08.jpg">
    <div v-if="love_show" class="goods_love">
      ...
      >
        ...
        <p class="goods_price_info">
          <span class="goods_price">
            <span><font>￥</font>{{goods.groupPrice}}</span>
...
export default {
  data() {
    return {
      ...
      timer: false,
         hc_id: [
        "3377459,2911300,2994246,3500823,2892691,2827055,2601062,2603659,3003902,65864,3271969,2655558",
        "3431005,3361041,3365085,2581296,2601345,3566232,3634051,2693996,1528916,37581,2600137,2602470",
        "2243947,2630692,2537409,2870450,2826718,1577567,2807194,1219273,2522932,2807214,4094881,4085208",
        "2755669,2755683,3495724,3546487,12951,1743565,3174045,3564916,1878118,2821682,2505056,3927881",
        "2598679,994764,1472288,88879,1208420,6102060,1121414,3059533,2224392,986658,63728,80987"
      ],
      // hc_id: [
  ...
  async mounted() {
    ...
    var imgs = [
      [
        require("../../assets/images/happies/23_1.png"),
        require("../../assets/images/happies/23_2.png")
      ],
      [
        require("../../assets/images/happies/24_1.png"),
        require("../../assets/images/happies/24_2.png")
      ],
      [
        require("../../assets/images/happies/25_1.png"),
        require("../../assets/images/happies/25_2.png")
      ],
      [
        require("../../assets/images/happies/26_1.png"),
        require("../../assets/images/happies/26_2.png")
      ],
      [
        require("../../assets/images/happies/27_1.png"),
        require("../../assets/images/happies/27_2.png")
      ]
    ];
  ...
  methods: {
    // 获得优惠券
    getCoupon: function() {
      this.$http.post(URL.coupon, this.userInfo).then(res => {
        console.log(res.data);
    ...
    //获得喜欢的商品
    loveGoods: function() {
      this.$http.post(URL.recommend, this.userInfo).then(res => {
        console.log(res.data);
        if (res.data == null || res.data == "undefined" || res.data == "null") {
          this.msgTxt = "请刷新页面";
        } else {
    ...
    togl() {
      ...
      window.location.$router = "/strategy";
    ...
    topage(page) {
      ...
      var source = ["index", "indexbanner", "advert"];
      source.map(function(el) {
        if (url.indexOf(el) > -1) {
          origin = el;
        }
      });
      if (origin == "indexbanner") {
        //此时在顶部轮
        jump_url = "/" + page + "hc_";
      } else {
        jump_url = "/" + page + "index";
      }
      window.location.$router = jump_url;
      this.$router.push(jump_url);
    },
    toms() {
      window.location.$router = "/flashSale";
    ...
    newData(index, arr) {
      ...
      if (arr instanceof Array) {
        ...
        var img = [
          {
            url: require("../../assets/images/happies/hc_05.jpg"),
            id: 315,
            name: "dress"
          },
          {
            url: require("../../assets/images/happies/hc_11.jpg"),
            id: 37,
            name: "general"
          },
          {
            url: require("../../assets/images/happies/hc_17.jpg"),
            id: 317,
            name: "shoesBag"
          },
          {
            url: require("../../assets/images/happies/hc_23.jpg"),
            id: 320,
            name: "makeup"
          },
          {
            url: require("../../assets/images/happies/hc_29.jpg"),
            id: 321,
            name: "food"
          }
        ];
...
.goods_price span font{
  font-family: MicrosoftYaHei;
  font-size: 0.28rem;
  
}  
.goods_price span:nth-last-child(2) {
  font-style: normal;
  font-family: Impact;
  font-stretch: normal;
	font-size: 0.44rem;
}
.goods_price span:nth-last-child(1) {
  font-family: MicrosoftYaHei;
  font-size: 0.24rem;
  font-weight: normal;
  font-stretch: normal;
...
.goods_buy {
  ...
  text-align: center;
  line-height: 0.44rem;
  box-shadow: inset 2px 4px 6px 0px 
		rgba(156, 4, 11, 0.43);
}
.goods_bottom {
  display: flex;
