  ...
  <div id="makeup">
    ...
    <header>
      ...
      <img class="img_text" :src="banner1" />
       <img class="share"  src="./../../../assets/images/icon/share.png"  @click="shareMini('share/makeup.jpg','女神美容院 塑造美人肌 低至1折起')">
      <roll class="center_scroll" :roll="roll1" v-if="timeEndSHOW"></roll>
    </header>
    <roll class="left_scroll" v-if="timeEndSHOW" :roll="roll"></roll>
    <pageButton v-if="showCenter" :pageData="page_button"></pageButton>
    ...
    <img v-lazy="hcImg" class="hc_img module0 module"  @click="jump2web('https://modeup.taojiji.com/taojiji/pages/2019/07/11db78145cba5d3abe-html5.html')" />
    <div class="hc_lists">
    ...
    <div class="shops module4 module">
      <img class="shop_title" src="./../../../assets/images/fhc/hd.jpg" />
       <div class="shop_lists">
           <div class="shop_list" v-for="(item,index) in shops" :key="index"  @click="toShop(item.shop_id)" >
...
export default {
  data() {
    return {
      hc_info: [
        {
          hc: "5-2",
          img: require("./../../../assets/images/fhc/ns_2.jpg"),
          index: 1,
          type: 0,
          url:"https://modeup.taojiji.com/taojiji/pages/2019/07/1136f3b307916583ba-html5.html"
        },
        {
          hc: "5-3",
          img: require("./../../../assets/images/fhc/ns_3.jpg"),
          index: 2,
          type: 0,
          num:3,
          url:"https://modeup.taojiji.com/taojiji/pages/2019/07/11f6454201b82e778b-html5.html"
        }, 
        {
          hc: "5-4",
      ...
      // banner: require("./../../../assets/images/fhc/banner_ns.jpg"),
  
      banner: require("./../../../assets/images/fhc/m1.jpg"),
      banner1: require("./../../../assets/images/fhc/m2.png"),
      hcImg: require("./../../../assets/images/fhc/fs_1.jpg"),
      fixed: false,
      changeNav_love: 0,
      timeEndSHOW: true,
  ...
  created() {
    document.getElementsByTagName("html")[0].style.backgroundColor = "#FF6A5F";
    document.getElementsByTagName("body")[0].style.backgroundColor = "#FF6A5F";
      let params = {
        coordinate:"19-5,20-5,21-5",
        activity_id:1,
      }
      this.$.initPv({
      ...
      this.$http.get(URL.topData, { params }).then(res => {
          ...
          //左上角气泡
          if(zy.result==1){
              if(zyData.link_info&&zyData.link_info['19-5']){
                  let rollData=[];
                  if(zyData.link_info["19-5"].length<=1){
                     rollData=[]
                  }else{
                    for (let index = 0; index <zyData.link_info['19-5'].length; index++) {
                     var obj = {
                        'txt' : zyData.link_info['19-5'][index].activity_name,
                        'url':zyData.link_info['19-5'][index].jump_link,
                        'type':'qipao'
                     }
                   rollData.push(obj);
                   this.roll = {
              ...
              //中部按钮
              if(zyData.link_info&&zyData.link_info['20-5']){
                  this.page_button = zyData.link_info['20-5'];
              }else{
                this.showCenter = false;
              }
              //气泡
              if(zyData.link_info&&zyData.link_info['21-5']){
                  
                  this.floatData = zyData.link_info['21-5'];
