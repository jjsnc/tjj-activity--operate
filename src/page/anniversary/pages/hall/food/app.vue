...
<template>
  <div id="food">
    ...
    <header>
      ...
      <img class="share"  src="./../../../assets/images/icon/share.png"  @click="shareMini('share/food.jpg','百万美食1元尝鲜 吃货满减优惠享不停')">
    ...
    <img v-lazy="hcImg" class="hc_img module0 module" @click="jump2web('https://modeup.taojiji.com/taojiji/pages/2019/07/16703e41680b49c15e-html5.html')" />
    <div class="hc_lists">
...
export default {
  data() {
    return {
      hc_info: [
        {
          hc: "6-2",
          img: require("./../../../assets/images/fhc/nf_2.jpg"),
          index: 1,
          type: 0,
          url:'https://modeup.taojiji.com/taojiji/pages/2019/07/16366a203f6ef02377-html5.html'
        },
        {
          hc: "6-3",
          img: require("./../../../assets/images/fhc/nf_3.jpg"),
          index: 2,
          type: 0,
          num:3,
          url:'https://modeup.taojiji.com/taojiji/pages/2019/07/167be9474b53b7d93a-html5.html'
        },
        {
          hc: "6-4",
      ...
      banner: require("./../../../assets/images/fhc/f1.jpg"),
      banner1: require("./../../../assets/images/fhc/f2.png"),
      hcImg: require("./../../../assets/images/fhc/nf_1.jpg"),
      fixed: false,
      changeNav_love: 0,
      timeEndSHOW: true,
  ...
  created() {
    document.getElementsByTagName("html")[0].style.backgroundColor = "#ffA762";
    document.getElementsByTagName("body")[0].style.backgroundColor = "#ffA762";
    this.$.initPv({
        pageName: "zhounian_06"
      });
    let params = {
        coordinate:"19-6,20-6,21-6",
        activity_id:1,
      }
      this.$http.get(URL.topData, { params }).then(res => {
          ...
          //左上角气泡
          if(zy.result==1){
              if(zyData.link_info&&zyData.link_info['19-6']){
                  let rollData=[];
                   if(zyData.link_info["19-6"].length<=1){
                     rollData=[]
                  }else{
                     for (let index = 0; index <zyData.link_info['19-6'].length; index++) {
                     var obj = {
                        'txt' : zyData.link_info['19-6'][index].activity_name,
                        'url':zyData.link_info['19-6'][index].jump_link,
                        'type':'qipao'
                     }
                   rollData.push(obj)
                  }
              ...
              //中部按钮
              if(zyData.link_info&&zyData.link_info['20-6']){
                  this.page_button = zyData.link_info['20-6'];
              }else{
                this.showCenter = false;
              }
              //气泡
              if(zyData.link_info&&zyData.link_info['21-6']){
                  
                  this.floatData = zyData.link_info['21-6'];
