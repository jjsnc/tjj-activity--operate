<template>
  <nav class="container">
    <div class="lb">
      <img src="../assets/images/dress_01.jpg">
      <div class="share" @click="share" v-if="xcx==false"></div>
    </div>
    <div class="shop_lists">
      <div>
        <div>
          <img src="../assets/images/1.jpg" @click="toShop('55229')">
          <img src="../assets/images/2.jpg" @click="toShop('26800')">
          <img src="../assets/images/3.png" @click="toShop('102159')">
          <img src="../assets/images/4.png" @click="toShop('99532')">
          <img src="../assets/images/5.jpg" @click="toShop('96234')">
          <img src="../assets/images/6.jpg" @click="toShop('31224')">
        </div>
      </div>
    </div>
    ...
    <img src="../assets/images/back_02.jpg" @click="back()" alt>
    <ToTop></ToTop>
  </nav>
</template>
<script>
