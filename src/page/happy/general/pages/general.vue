<template>
  <nav class="container">
    <div class="lb">
      <img src="../assets/images/general_01.jpg">
      <div class="share" @click="share" v-if="xcx==false"></div>
    </div>
    <img src="../assets/images/general_03.jpg">
    ...
    <div class="lists">
      ...
      >
        ...
        <div v-if="goods_lists[index].length/2>0&&index==4" class="moregoods more">
          <img src="../assets/images/more_07.jpg" @click="toMore()" alt>
        </div>
      </div>
    </div>

    <img src="../assets/images/general_05.jpg" @click="back()" alt>
    <ToTop></ToTop>
  </nav>
</template>
<script>
...
export default {
  data() {
    return {
      goods: [],
      shops: [
        { url: require("../assets/images/1.png"), id: "21583" },
        { url: require("../assets/images/2.jpg"), id: "13546" },
        { url: require("../assets/images/3.jpg"), id: "15216" },
        { url: require("../assets/images/4.png"), id: "80116" },
        { url: require("../assets/images/5.png"), id: "22547" },
        { url: require("../assets/images/6.png"), id: "34127" }
      ],
      navs: [
        { name: "热销榜单" },
        { name: "居家好物" },
